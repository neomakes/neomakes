...
### 📂 Projects
* **[neoLAT](https://github.com/neomakes/neoLAT)** — *Local Agent Testbed*; An automated testbed for evaluating **L**ocal Agent efficiency and monitoring on-device AI trends.
